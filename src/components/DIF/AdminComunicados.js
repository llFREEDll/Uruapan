...
const AdminComunicados = () => {
    ...
    const PostComunicados = async() =>{
        ...
        await axios.post(urls.comunicadosDif,form,{headers:{'content-type':'multipart/form-data'}})
        .then(response =>{
    ...
    const PutCarousel = async() =>{
        ...
        //console.log(form);
        await axios.post(urls.comunicadosDif,form,{params: {id: Number(comunicadoSeleccionado.id) }})
        .then(response =>{
            var newData = data;
    ...
    const DeleteCarousel=async()=>{
        ...
        await axios.post(urls.comunicadosDif, f, {params: {id: Number(comunicadoSeleccionado.id) }})
        .then(response=>{
