            ...
            <div> 
                ...
                <div className = "container my-5">
                    <div className = "row row-cols-1 row-cols-md-2 g-4">
                        <CardLogoDownLine Link = "/tramites-en-linea/Agua" img = {waterLogo} p  = "¿No quieres hacer fila en  CAPASU? Paga en línea tu servicio de agua "/>
                        <CardLogoDownLine Link = "/tramites-en-linea/multas" img = {multasLogo} p  = "Paga tus multas impuestas por tránsito al momento"/>
                        ...
                        <CardLogoDownLine Link = "/tramites-en-linea/licencia-comercial" img = {licenciaComerLogo} p  = "Tramita en linea tu licencia comercial"/>    
                    </div>
                </div>
